...
export class SplashScreenScene : public Scene {
	using Scene::Scene;
private:
	nanoseconds m_finalizeStartTime = nanoseconds(0);
	nanoseconds m_finalizeTime = nanoseconds(seconds(2));
public:
	void Init() noexcept override;
	void OnUpdate() noexcept override;
	void OnBeginActivate() noexcept override;
	void OnActivated() noexcept override;
	void OnBeginDeactivate() noexcept override;	
	void OnDeactivate() noexcept override;
	void OnEndDeactivate() noexcept override;
};

// export namespace ResourcePaths::Picture {
...
// 	}
// 	const milliseconds m_activateTime = milliseconds(5000);
