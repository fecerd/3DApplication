...
export namespace System {
	...
	public: /* input/output_iteratorÇ…ïKê{ */
	...
	public:
		constexpr node_type*& GetNode() noexcept { return ptr; }
		constexpr node_type* const& GetNode() const noexcept { return ptr; }
	public:/* bidirectional_iteratorÇ…ïKê{ */
	...
	public:
		constexpr node_type*& GetNode() noexcept { return ptr; }
		constexpr node_type* const& GetNode() const noexcept { return ptr; }
	public: /* random_access_iteratorÇ…ïKê{ */
	...
	public:
		constexpr node_type*& GetNode() noexcept { return ptr; }
		constexpr node_type* const& GetNode() const noexcept { return ptr; }
	public:/* contiguous_iteratorÇ…ïKê{ */
