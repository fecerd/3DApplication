export module OpenType_Internal0;
...
#undef UNICODE
	...
	String GetDICTOperatorName(DICTOperator opr) noexcept {
		switch (opr) {
		case DICTOperator::version: return EnumInfo<DICTOperator, DICTOperator::version>::GetValueName();
		case DICTOperator::Notice: return EnumInfo<DICTOperator, DICTOperator::Notice>::GetValueName();
		case DICTOperator::Fullname: return EnumInfo<DICTOperator, DICTOperator::Fullname>::GetValueName();
		case DICTOperator::FamilyName: return EnumInfo<DICTOperator, DICTOperator::FamilyName>::GetValueName();
		case DICTOperator::Weight: return EnumInfo<DICTOperator, DICTOperator::Weight>::GetValueName();
		case DICTOperator::isFixedPitch: return EnumInfo<DICTOperator, DICTOperator::isFixedPitch>::GetValueName();
		case DICTOperator::ItalicAngle: return EnumInfo<DICTOperator, DICTOperator::ItalicAngle>::GetValueName();
		case DICTOperator::UnderlinePosition: return EnumInfo<DICTOperator, DICTOperator::UnderlinePosition>::GetValueName();
		case DICTOperator::UnderlineThickness: return EnumInfo<DICTOperator, DICTOperator::UnderlineThickness>::GetValueName();
		case DICTOperator::PaintType: return EnumInfo<DICTOperator, DICTOperator::PaintType>::GetValueName();
		case DICTOperator::CharstringType: return EnumInfo<DICTOperator, DICTOperator::CharstringType>::GetValueName();
		case DICTOperator::UniqueID: return EnumInfo<DICTOperator, DICTOperator::UniqueID>::GetValueName();
		case DICTOperator::StrokeWidth: return EnumInfo<DICTOperator, DICTOperator::StrokeWidth>::GetValueName();
		case DICTOperator::charset: return EnumInfo<DICTOperator, DICTOperator::charset>::GetValueName();
		case DICTOperator::Encoding: return EnumInfo<DICTOperator, DICTOperator::Encoding>::GetValueName();
		case DICTOperator::CharStrings: return EnumInfo<DICTOperator, DICTOperator::CharStrings>::GetValueName();
		case DICTOperator::SyntheticBase: return EnumInfo<DICTOperator, DICTOperator::SyntheticBase>::GetValueName();
		case DICTOperator::PostScript: return EnumInfo<DICTOperator, DICTOperator::PostScript>::GetValueName();
		case DICTOperator::BaseFontName: return EnumInfo<DICTOperator, DICTOperator::BaseFontName>::GetValueName();
		case DICTOperator::BaseFontBlend: return EnumInfo<DICTOperator, DICTOperator::BaseFontBlend>::GetValueName();
		case DICTOperator::CIDFontVersion: return EnumInfo<DICTOperator, DICTOperator::CIDFontVersion>::GetValueName();
		case DICTOperator::CIDFontRevision: return EnumInfo<DICTOperator, DICTOperator::CIDFontRevision>::GetValueName();
		case DICTOperator::CIDFontType: return EnumInfo<DICTOperator, DICTOperator::CIDFontType>::GetValueName();
		case DICTOperator::CIDCount: return EnumInfo<DICTOperator, DICTOperator::CIDCount>::GetValueName();
		case DICTOperator::UIDBase: return EnumInfo<DICTOperator, DICTOperator::UIDBase>::GetValueName();
		case DICTOperator::FDArray: return EnumInfo<DICTOperator, DICTOperator::FDArray>::GetValueName();
		case DICTOperator::FDSelect: return EnumInfo<DICTOperator, DICTOperator::FDSelect>::GetValueName();
		case DICTOperator::FontName: return EnumInfo<DICTOperator, DICTOperator::FontName>::GetValueName();
		case DICTOperator::BlueScale: return EnumInfo<DICTOperator, DICTOperator::BlueScale>::GetValueName();
		case DICTOperator::BlueShift: return EnumInfo<DICTOperator, DICTOperator::BlueShift>::GetValueName();
		case DICTOperator::BlueFuzz: return EnumInfo<DICTOperator, DICTOperator::BlueFuzz>::GetValueName();
		case DICTOperator::StdHW: return EnumInfo<DICTOperator, DICTOperator::StdHW>::GetValueName();
		case DICTOperator::StdVW: return EnumInfo<DICTOperator, DICTOperator::StdVW>::GetValueName();
		case DICTOperator::ForceBold: return EnumInfo<DICTOperator, DICTOperator::ForceBold>::GetValueName();
		case DICTOperator::LanguageGroup: return EnumInfo<DICTOperator, DICTOperator::LanguageGroup>::GetValueName();
		case DICTOperator::ExpansionFactor: return EnumInfo<DICTOperator, DICTOperator::ExpansionFactor>::GetValueName();
		case DICTOperator::initialRandomSeed: return EnumInfo<DICTOperator, DICTOperator::initialRandomSeed>::GetValueName();
		case DICTOperator::Subrs: return EnumInfo<DICTOperator, DICTOperator::Subrs>::GetValueName();
		case DICTOperator::defaultWidthX: return EnumInfo<DICTOperator, DICTOperator::defaultWidthX>::GetValueName();
		case DICTOperator::nominalWidthX: return EnumInfo<DICTOperator, DICTOperator::nominalWidthX>::GetValueName();
		case DICTOperator::Private: return EnumInfo<DICTOperator, DICTOperator::Private>::GetValueName();
		case DICTOperator::ROS: return EnumInfo<DICTOperator, DICTOperator::ROS>::GetValueName();
		case DICTOperator::FontMatrix: return EnumInfo<DICTOperator, DICTOperator::FontMatrix>::GetValueName();
		case DICTOperator::FontBBox: return EnumInfo<DICTOperator, DICTOperator::FontBBox>::GetValueName();
		case DICTOperator::XUID: return EnumInfo<DICTOperator, DICTOperator::XUID>::GetValueName();
		case DICTOperator::BlueValues: return EnumInfo<DICTOperator, DICTOperator::BlueValues>::GetValueName();
		case DICTOperator::OtherBlues: return EnumInfo<DICTOperator, DICTOperator::OtherBlues>::GetValueName();
		case DICTOperator::FamilyBlues: return EnumInfo<DICTOperator, DICTOperator::FamilyBlues>::GetValueName();
		case DICTOperator::FamilyOtherBlues: return EnumInfo<DICTOperator, DICTOperator::FamilyOtherBlues>::GetValueName();
		case DICTOperator::StemSnapH: return EnumInfo<DICTOperator, DICTOperator::StemSnapH>::GetValueName();
		case DICTOperator::StemSnapV: return EnumInfo<DICTOperator, DICTOperator::StemSnapV>::GetValueName();
		default: return String(u"Undefined Operator");
		}
	}
...
namespace System {
	...
	struct SubTableBase16 : public SubTable {
		...
		uint16_t language;
	public:
		SubTableBase16(IO::FileStream& file, uint16_t format) noexcept : SubTable(format) {
			if (format > 6) return;
			file.ReadBE(length);
	...
	struct SubTableBase32 : public SubTable {
		...
		uint32_t language;
	public:
		SubTableBase32(IO::FileStream& file, uint16_t format) noexcept : SubTable(format) {
	...
	public:
		SubTableFormat0(IO::FileStream& file) noexcept : SubTableBase16(file, 0) {
	...
	struct SubTableFormat2 : public SubTableBase16 {
		...
		public:
			...
			SubHeader(IO::FileStream& file) noexcept {
	...
	public:
		...
		VectorBase<SubHeader> subHeaders;
		// グリフインデックスの配列。
	...
	public:
		SubTableFormat2(IO::FileStream& file) noexcept : SubTableBase16(file, 2) {
	...
	public:
		SubTableFormat4(IO::FileStream& file) noexcept : SubTableBase16(file, 4) {
	...
	struct SubTableFormat6 : public SubTableBase16 {
		...
		uint16_t* glyphIdArray = nullptr;
	public:
		SubTableFormat6(IO::FileStream& file) noexcept : SubTableBase16(file, 6) {
			file.ReadBE(firstCode);
			file.ReadBE(entryCount);
	...
	public:
		SubTableFormat8(IO::FileStream& file) noexcept : SubTableBase32(file, 8) {
			file.ReadBE(is32);
	...
	public:
		SubTableFormat10(IO::FileStream& file) noexcept : SubTableBase32(file, 10) {
			file.ReadBE(startCharCode);
	...
	struct SubTableFormat12 : public SubTableBase32 {
		...
		SequentialMapGroup* groups = nullptr;
	public:
		SubTableFormat12(IO::FileStream& file) noexcept : SubTableBase32(file, 12) {
			file.ReadBE(numGroups);
			groups = new SequentialMapGroup[numGroups];
			for (uint32_t i = 0; i < numGroups; ++i) groups[i].Load(file);
		}
	...
	public:
		SubTableFormat13(IO::FileStream& file) noexcept : SubTableBase32(file, 13) {
			file.ReadBE(numGroups);
	...
	struct SubTableFormat14 : public SubTableBase32 {
		...
		VectorBase<DefaultUVS> defaultUVS;
		//varSelector[n].nonDefaultUVSOffsetをインデックスとする動的配列
		VectorBase<NonDefaultUVS> nonDefaultUVS;
	public:
		SubTableFormat14(IO::FileStream& file) noexcept : SubTableBase32(file, 14) {
			//SubTableBase32で読み込まれるバイト数戻して、サブテーブルの先頭位置を取得する
			file.Seek(-6, IO::SeekDirs::Current);
			IO::StreamPos subTableBegin = file.TellPos();
			file.Seek(6, IO::SeekDirs::Current);
			...
			//すでに読み込んだオフセット値を記録する
			VectorBase<uint32_t> defaultUVSOffsets;
			VectorBase<uint32_t> nonDefaultUVSOffsets;
			...
			for (VariationSelector* selector = varSelector, *end = varSelector + numVarSelectorRecords; selector != end; ++selector) {
				...
				if (offsetCount != offsetIndex) selector->defaultUVSOffset = static_cast<uint32_t>(offsetIndex);
					...
					file.Seek(selector->defaultUVSOffset, IO::SeekDirs::Current);
					DefaultUVS tmp;
					tmp.Load(file);
				...
				if (offsetCount != offsetIndex) selector->nonDefaultUVSOffset = static_cast<uint32_t>(offsetIndex);
					...
					file.Seek(subTableBegin);
					file.Seek(selector->nonDefaultUVSOffset, IO::SeekDirs::Current);
					NonDefaultUVS tmp;
					tmp.Load(file);
	...
	public:
		uint16_t GetGID(uint32_t) const noexcept override {
			return 0;
		}
	};
}
...
export namespace System {
	...
	public:
		...
		VectorBase<SubTable*> subTables;
	private:
		uint16_t m_unicodeSubtableIndex = MAX_VALUE<uint16_t>;
	public:
		~CMAP() {
	...
	private:
		uint16_t GetUnicodeSubTableIndex() const noexcept {
			uint16_t ret = MAX_VALUE<uint16_t>;
			uint16_t platformID = MAX_VALUE<uint16_t>;
			uint16_t encodingID = MAX_VALUE<uint16_t>;
			for (uint16_t i = 0; i < numTables; ++i) {
				EncodingRecord& enc = encodingRecords[i];
				if (enc.platformID == 0) {
					if (enc.encodingID == 5) continue;
					if (platformID == MAX_VALUE<uint16_t>) {
	...
	public:
		...
		/// </param>
		/// <returns>読み取り後のFileStreamの状態値</returns>
		bool Load(IO::FileStream& file, uint32_t offset) noexcept {
			file.Seek(offset, IO::SeekDirs::Begin);
			IO::StreamPos cmapPos = file.TellPos();
			file.ReadBE(version);
			file.ReadBE(numTables);
			//エンコーディングレコード取得
			...
			for (uint16_t i = 0; i < numTables; ++i) {
				file.Seek(cmapPos);
				file.Seek(encodingRecords[i].offset, IO::SeekDirs::Current);
		...
		/// </param>
		/// <returns>読み取り後のFileStreamの状態値</returns>
		bool QuickLoad(IO::FileStream& file, uint32_t offset) noexcept {
			file.Seek(offset, IO::SeekDirs::Begin);
			IO::StreamPos cmapPos = file.TellPos();
			file.ReadBE(version);
			file.ReadBE(numTables);
			...
			file.Seek(cmapPos);
			file.Seek(encodingRecords[m_unicodeSubtableIndex].offset, IO::SeekDirs::Current);
			uint16_t format = 0xffff;
			file.ReadBE(format);
			if (format == 0xffff) return false;
			switch (format) {
...
export namespace System {
	...
	public:
		...
		bool Load(IO::FileStream& file, uint32_t offset) noexcept {
			if (!file) return false;
			file.Seek(static_cast<IO::StreamOff>(offset), IO::SeekDirs::Begin);
...
export namespace System {
	...
	public:
		bool Load(IO::FileStream& file, uint32_t offset, const HHEA& hhea, const MAXP& maxp) noexcept {
...
export namespace System {
	...
	public:
		bool Load(IO::FileStream& file, uint32_t offset, const HEAD& head, const MAXP& maxp) noexcept {
			file.Seek(offset, IO::SeekDirs::Begin);
	...
	public:
		...
		constexpr uint32_t GetOffset(uint16_t gid) const noexcept {
			return gid < m_offsetCount ? offsets[gid] : MAX_VALUE<uint32_t>;
		}
	};
}

export namespace System {
	void PixelInverse(Drawing::Pixel* line0, uint32_t x, uint32_t xEnd) noexcept {
...
namespace System {
	...
	public:
		bool Load(IO::FileStream& file, const Glyph& glyph) noexcept;
	public:
		Drawing::Image GetGlyphImage(const Glyph& glyph, float scale, const Drawing::Pixel& contoursPixel) const noexcept;
	};
	...
	public:
		bool Load(IO::FileStream& file, const MAXP& maxp) noexcept {
	...
	public:
		Drawing::Image GetGlyphImage(const Glyph& glyph, float scale, const Drawing::Pixel& contoursPixel) noexcept;
	};
	...
	public:
		...
		bool Load(IO::FileStream& file, uint32_t tableOffset, uint32_t glyphOffset, const MAXP& maxp) noexcept {
			file.Seek(tableOffset, IO::SeekDirs::Begin);
			file.Seek(glyphOffset, IO::SeekDirs::Current);
	...
	public:
		Drawing::Image GetGlyphImage(float scale, const Drawing::Pixel& contoursPixel) const noexcept {
			if (!simple) return Drawing::Image();
	...
	bool SimpleGlyph::Load(IO::FileStream& file, const Glyph& glyph) noexcept {
	...
	Drawing::Image SimpleGlyph::GetGlyphImage(const Glyph& glyph, float scale, const Drawing::Pixel& contoursPixel) const noexcept {
		Drawing::Image ret{
			static_cast<uint32_t>((glyph.xMax - glyph.xMin) * scale) + 1,
			static_cast<uint32_t>((glyph.yMax - glyph.yMin) * scale) + 1
		};
		Drawing::Pixel* pixels = ret.Data();
		...
		for (uint16_t i = 0; i < glyph.numberOfContours; ++i) {
			...
			//制御点から2次Bスプライン曲線を生成
			BSpline bspline;
			bspline.SetFunction(points, numPoints, 2, Math::Max(xMax, yMax), true);
			delete[] points;
			...
			for (Point<int32_t>& p : bspline.Splines(0, 0, xMax, yMax)) {
				...
				uint32_t y = yMax - p.y;
				//座標(0, y)のピクセルへのポインタ
				Drawing::Pixel* line0 = pixels + (y * (xMax + 1));
			...
			if (yFirstSign && yFirstSign == yPrevSign) {
				Drawing::Pixel* line0 = pixels + (prev.y * (xMax + 1));
				PixelInverse(line0, prev.x, xMax);
			}
		}
		//アルファ値0x00のピクセルを黒色(0x000000ff)に塗りつぶす
		for (uint32_t y = 0; y <= yMax; ++y) {
			Drawing::Pixel* line0 = pixels + (xMax + 1ull) * y;
	...
	Drawing::Image CompositeGlyph::GetGlyphImage(const Glyph& glyph, float scale, const Drawing::Pixel& /*contoursPixel*/) noexcept {
		Drawing::Image ret{
			static_cast<uint32_t>((glyph.xMax - glyph.xMin) * scale) + 1,
			static_cast<uint32_t>((glyph.yMax - glyph.yMin) * scale) + 1
		};
...
export namespace System {
	...
	public:
		...
		bool Load(IO::FileStream& file, uint32_t offset, const MAXP& maxp, const HMTX& hmtx, const LOCA& loca) noexcept {
	...
	public:
		Drawing::Image GetGlyphImageByGID(uint16_t gid, float scale, const Drawing::Pixel& contoursPixel) const noexcept {
			if (gid < m_numGlyphs) return glyphs[gid].GetGlyphImage(scale, contoursPixel);
			else return Drawing::Image();
		}
...
export namespace System {
	...
	public:
		bool Load(IO::FileStream& file, uint32_t cff1Offset, uint32_t indexOffset) {
			if (indexOffset) file.Seek(cff1Offset + indexOffset, IO::SeekDirs::Begin);
			file.ReadBE(count);
	...
	public:
		bool Load(IO::FileStream& file, uint32_t cff1Offset, uint32_t indexOffset, uint8_t charstringType) noexcept {
	...
	public:
		bool Load(IO::FileStream& file, uint32_t privateDICTSize, uint32_t cff1Offset, uint32_t privateDICTOffset, uint8_t charstringType) noexcept {
			file.Seek(cff1Offset + privateDICTOffset, IO::SeekDirs::Begin);
	...
	public:
		bool Load(IO::FileStream& file, uint32_t cff1Offset, uint32_t fdSelectOffset, uint16_t numGlyphs) noexcept {
			file.Seek(cff1Offset + fdSelectOffset, IO::SeekDirs::Begin);
			file.ReadBE(format);
			if (format == 0) {
	...
	struct CFF1Header {
		...
		uint8_t offSize;
	public:
		bool Load(IO::FileStream& file, uint32_t cff1Offset) noexcept {
			file.Seek(cff1Offset, IO::SeekDirs::Begin);
			file.ReadBE(majorVersion);
			file.ReadBE(minorVersion);
	...
	public:
		bool Load(IO::FileStream& file, uint32_t cff1Offset, uint32_t encodingOffset) noexcept {
			file.Seek(cff1Offset + encodingOffset, IO::SeekDirs::Begin);
			file.ReadBE(format);
			if (format == 0) {
				file.ReadBE(nCodes);
	...
	public:
		bool Load(IO::FileStream& file, uint32_t cff1Offset, uint32_t charsetOffset, uint16_t numGlyphs) noexcept {
			file.Seek(cff1Offset + charsetOffset, IO::SeekDirs::Begin);
			file.ReadBE(format);
			if (format == 0) {
